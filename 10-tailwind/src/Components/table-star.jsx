...
function TableStar() {
  return (
    <div className="bg-gray-200  mt-30 flex flex-col text-center items-center justify-center h-100 gap-10">
      <div className="flex">
        <svg
          version="1.0"
          id="Layer_1"
      ...
      <h1 className="text-3xl w-5/10 font-medium">“I didn’t know a thing about icon design until I read this book. Now I can create any icon I need in no time. Great resource!”</h1>
